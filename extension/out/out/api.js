...
exports.CesaFlowApi = void 0;
const vscode = __importStar(require("vscode"));
const https = __importStar(require("https"));
const http = __importStar(require("http"));
class CesaFlowApi {
    get apiKey() {
        return vscode.workspace.getConfiguration('cesaflow').get('apiKey', '');
    }
    get serverUrl() {
        return vscode.workspace.getConfiguration('cesaflow').get('serverUrl', 'http://localhost:8001');
    }
    get isConfigured() {
...
exports.CesaFlowApi = CesaFlowApi;
